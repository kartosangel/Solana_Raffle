export type RafflooorProgram = {
  "version": "0.1.0",
  "name": "rafflooor_program",
  "instructions": [
    {
        ...
        "fields": [
          {
            "name": "rafflooor",
            "docs": [
              "rafflooor account that owns this raffle (32)"
            ],
            "type": "publicKey"
          },
          {
          ...
          },
          {
            "name": "entryType",
            "docs": [
              "type of entry - Token or NFT (1 + 32)"
            ],
            "type": {
              "defined": "EntryType"
            }
          },
          {
            "name": "burnOnPurchase",
            "docs": [
              "whether to burn the entry cost on purchase - not allowed for SOL (1)"
            ],
            "type": "bool"
          },
          {
            ...
            "docs": [
              "gate to only holders of a specific collection"
            ],
            "type": {
              "option": "publicKey"
            }
          ...
          },
          {
            "name": "unlimited",
            "docs": [
              "does this raffle have unlimited tickets? (1)"
            ],
            "type": "bool"
          },
          {
...
export const IDL: RafflooorProgram = {
  "version": "0.1.0",
  "name": "rafflooor_program",
  "instructions": [
    {
